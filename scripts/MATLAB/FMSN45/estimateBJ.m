% FUNCTION [ foundModel, ey, acfEst, pacfEst ] = estimateBJ( y, x, C1, A1, B, A2, titleStr, noLags, [beSilent] )
%
% The function estimates the Box-Jenkins model
% 
%   y(t) = [ B(z) / A2(z)] x(t) + [ C1(z)/A1(z) ] e(t)
% 
% and returns the found model and the residual. . If beSilent is set, no
...
ey = resid( foundModel, dataContainer ); ey = ey.y( length(foundModel.B):end );
